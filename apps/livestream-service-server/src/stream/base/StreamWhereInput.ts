...
import { PeerConnectionListRelationFilter } from "../../peerConnection/base/PeerConnectionListRelationFilter";
...
class StreamWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PeerConnectionListRelationFilter,
  })
  @ValidateNested()
  @Type(() => PeerConnectionListRelationFilter)
  @IsOptional()
  @Field(() => PeerConnectionListRelationFilter, {
    nullable: true,
  })
